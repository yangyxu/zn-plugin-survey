...
module.exports = React.createClass({
	...
	render:function(){
		return (
			<zn.react.Page canBack={false} className="zn-plugin-survey-paper-list" title='问卷列表' toolbarItems={this.props.data?this.state.toolbarItems:[]} onToolbarClick={this.__onToolbarClick}
