...
module.exports = React.createClass({
	getDefaultProps: function () {
		return {
			...
			fields: [
				...
				{ title: '表前缀', type: 'Input', name: 'table_prefix', value: 'zn_plugin_survey_paper_table_' },
	...
	render:function(){
		return (
			<zn.plugin.admin.TreeModelView {...this.props} emptyRender={()=><PaperList />} rightRender={this.__rightRender} leftWidth={160} />
		);
	}
});
