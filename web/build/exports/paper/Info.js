...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			zn.react.Page,
			{ canBack: false, className: 'zn-plugin-survey-paper-list', title: '\u95EE\u5377\u5217\u8868', toolbarItems: this.props.data ? this.state.toolbarItems : [], onToolbarClick: this.__onToolbarClick,
