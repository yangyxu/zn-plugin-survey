...
module.exports = React.createClass({
	...
	getDefaultProps: function getDefaultProps() {
		return {
			...
			pid: 0,
			title: '问卷类型管理',
			fields: [{ title: '类型名称', type: 'Input', name: 'zn_title' }, { title: '表前缀', type: 'Input', name: 'table_prefix', value: 'zn_plugin_survey_paper_table_' }, { title: '是否启用权限', type: 'Radio', name: 'zn_rights_enabled', value: 0,
	...
	__rightRender: function __rightRender(data) {
		return React.createElement(PaperList, { data: data });
	},
