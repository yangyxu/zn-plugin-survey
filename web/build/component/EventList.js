...
module.exports = React.createClass({
	...
	getInitialState: function getInitialState() {
		return {
			...
			formItems: [{ title: '活动名称', name: 'zn_title', type: 'Input', required: true, error: '名称必填项!' }, { title: '最大限制', name: 'max_count', type: 'Input', attrs: { type: 'number' } }, { title: '显示余量', name: 'show_count', type: 'Radio', value: 0, data: [{ value: 0, text: '否' }, { value: 1, text: '是' }] }, { title: '唯一性验证', name: 'unique_check', type: 'Radio', value: 0, data: [{ value: 0, text: '否' }, { value: 1, text: '是' }] }, { title: '发送邮件', name: 'unique_check', type: 'Radio', value: 0, data: [{ value: 0, text: '否' }, { value: 1, text: '是' }] }, { title: '开始时间', name: 'start_time', type: 'DateTime', attrs: { type: 'date' }, required: true }, { title: '结束时间', name: 'end_time', type: 'DateTime', attrs: { type: 'date' }, required: true }, { title: '成功消息', name: 'success_message', type: 'RichEditor' }, { title: '失败消息', name: 'error_message', type: 'RichEditor' }, { title: '背景图片', name: 'background_image', type: 'ImageUploader' }, { title: '页脚标题', name: 'footer_title', type: 'Textarea' }, { title: '附件', name: 'attachments', type: 'FileUploader' }, { title: '备注', name: 'comment', type: 'Textarea' }, { title: '说明', name: 'zn_note', type: 'Textarea' }],
